//http://v.17173.com/api/VideoList/GetVideoLists?big_class=4&sub_class=4040522
...
Page({
    ...
    handleLoadMore () {
        ...
        wx.request({
            ...
            url: 'http://v.17173.com/api/VideoList/GetVideoLists?big_class=4&sub_class=4040522', //仅为示例，并非真实的接口地址
            data: {
                city:this.data.city,
